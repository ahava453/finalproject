...
const PLATFORM_META = {
  ...
  facebook: {
    hint: 'Facebook Page URL (profile) or a single Post URL',
    placeholder: 'https://www.facebook.com/NASA  or  https://www.facebook.com/.../posts/...',
    keyLabel: 'Apify API Token',
    keyPlaceholder: 'apify_api_xxxxxxxxxxxx',
    docLink: { href: 'https://docs.apify.com/api/v2#/introduction/authentication', text: 'How to get Apify Token' },
  },
  instagram: {
    hint: 'Instagram profile URL or a single Post/Reel URL',
    placeholder: 'https://www.instagram.com/nasa/  or  https://www.instagram.com/p/ABC123/',
    keyLabel: 'Apify API Token',
    keyPlaceholder: 'apify_api_xxxxxxxxxxxx',
    docLink: { href: 'https://docs.apify.com/api/v2#/introduction/authentication', text: 'How to get Apify Token' },
  },
